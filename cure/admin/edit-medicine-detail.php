...
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
 $query->execute();
   ...
   $query->execute();
    ...
    echo '<script>alert("Medicine Detail has been updated")</script>';
...
<head>
  ...
  <title>Cure | Update Medicine Detail</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Update Medicine Detail</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Update Medicine Detail</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
