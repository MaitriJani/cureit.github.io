...
<head>
	...
	<title>Cure|| Medicine Detail</title>
...
<body>
	...
	<?php include_once('includes/header.php');?>
		...
		<div class="page-title-wrap bgorange-1 padding-top-30 padding-bottom-30"><!-- section title -->
			<h4 class="white">Medicine Detail</h4>
								...
								<div class="listing-contact-detail-wrap">
									...
									<div class="listing-contact-section-table">
										<div class="listing-contact-table-field">
											<ul>
												<li class="info">Medicine Name</li>
												<li class="details"><?php  echo $row->MedicineName;?> </li>
											</ul>
										</div>
										<div class="listing-contact-table-field">
											<ul>
												<li class="info">Price</li>
												<li class="details"><?php  echo $row->Price;?> </li>
											</ul>
										</div>
										<!--<div class="listing-contact-table-field">
											<ul>
										...
										<div class="listing-contact-table-field">
											<ul>
												<li class="info">Seller name</li>
												<li class="details"><?php  echo $row->seller_name;?></li>
											</ul>
										</div>
						...
						<div class="sidebar sidebar-wrap">
							...
							<div class="sidebar-widget shadow-1">
								<div class="sidebar-widget-title">
									<h5><span class="bgblue-1"></span>Your Medicine</h5>
								</div>
